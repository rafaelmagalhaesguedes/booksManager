  ...
  describe('#update', () => {
    ...
    describe('quando existe o livro', () => {
      ...
      it('retorna true', async () => {
        ...
        expect(JSON.stringify(updated)).to.equal(JSON.stringify([true]));
      });
    });
    ...
    describe('quando não existe o livro', () => {
      ...
      it('retorna 0', async () => {
        expect(JSON.stringify(updated)).to.equal(JSON.stringify([false]));
      });
    });
  });
  ...
  describe('#remove', () => {
    ...
    describe('quando existe o livro', () => {
      before(async () => {
        ...
        removed = await BookService.exclude(2);
      });
    ...
    describe('quando não existe o livro', () => {
      before(async () => {
        ...
        updated = await BookService.exclude(1000);
      });
